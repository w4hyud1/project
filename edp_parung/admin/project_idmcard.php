...
<div id="templatemo_container">
    ...
    <div id="templatemo_content_wrapper">
        ...
        <div class="content_title_02">Laporan Project IDMCARD Perbulan</div>
        <hr />
            <table width="100%">
            ...
            <tr bgcolor="#333333" align="center">
                <td colspan="8">Pilih User EDP : <select name="user_edp">
                                                    ...
                                                    <?php 
                                                        $sql=mysql_query("select pic from idmcard where pic is not null group by pic order by pic");
            ...
            if($_POST['tampilkan']){
                ...
                $nbln=$_POST['nbln']+1;
                $sql=mysql_query("select * from idmcard where month(tanggal)='$nbln' and pic='$user_edp' order by tanggal");   
