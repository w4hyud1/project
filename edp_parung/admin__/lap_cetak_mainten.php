...
<?php
// LAPORAN PETUGAS
	   echo "<b><font size='4'>LAPORAN MAINTENENT BULANAN</font><b><br>";
...
<br />
  ...
  ?>
        <tr>
          ...
          <td class="td1"><?php echo $row_id['ganti_hadware'];?></td>
          <td class="td1"><?php echo $row_id['perbaikan_program'];?></td>
          <td class="td1"><?php echo $row_id['keter'];?></td>
