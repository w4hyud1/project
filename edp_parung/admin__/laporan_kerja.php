...
<div id="templatemo_container">
    ...
    <div id="templatemo_content_wrapper">
        ...
        <div class="content_title_02">Laporan Kerja EDP Lapangan Perbulan</div>
        <hr />
            <table width="100%">
            ...
            <tr bgcolor="#333333" align="center">
                <td colspan="8">Pilih User EDP : <select name="user_edp">
                                                    ...
                                                    <?php 
                                                        $sql=mysql_query("select id from rkb_edp_201503 where id is not null group by id order by id");
            ...
            if($_POST['tampilkan']){
                ...
                $tgl_sql=date("Y")."".$nbln;
                $sql=mysql_query("select * from rkb_edp_".$tgl_sql." where id='$user_edp'");
