...
if(isset($_POST['simpan'])){
    ...
    $keter=$_POST['keter'];
    $tanggal=date("Y-m-d");
    $mysql=mysql_query("update rkb_edp_".$ctgl." set status='$status',keter='$keter',tanggal='$tanggal' where kdtk='$kdtk'");
    if($mysql){
        ...
        <form method="POST" action="project_idmcard.php" >
            ...
            <tr>
                <td>KDTK / Nama Toko</td><td>: <select name="kdtk">
                                    <option></option>
                                    <?php 
                                      $mysql=mysql_query("select * from area_edp_201503 where id='$id' and kdtk not in(select kdtk from idmcard)");
            ...
            <tr>
                <td>Type EDC</td><td>: <input type="text" name="type_edc"/></td>
            </tr>
            <tr>
                <td>IP EDC</td><td>: <input type="text" name="ip_edc"/></td>
            </tr>
            <tr>
                <td>masalah</td><td>: <textarea name="masalah" rows="6" cols="30"></textarea></td>
            </tr>
            <tr>
            ...
            <tr>
                <td>Jabatan</td><td>: <select name="jbt">
                                                <option value=""></option>                                                                                            
