...
<a href="<?php echo base_url()."reporting/add"?>">
            ...
            echo "<tr>
                    ...
                    <td>
                        <div class='hidden-sm hidden-xs action-buttons'>
                            ...
                            <a class='green' href='reporting/edit/".$row->id."'>
                                <i class='ace-icon fa fa-pencil bigger-130'></i>
                            </a>

                            <a class='red' href='reporting/delete/".$row->id."' onclick='return ConfirmDialog();'>
