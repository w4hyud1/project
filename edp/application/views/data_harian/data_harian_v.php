...
<a href="<?php echo base_url()."data_harian/add"?>">
    ...
    <?php
        ...
        foreach ($recod as $row) {
            echo "<tr>
                    ...
                    <td>$row->toko_kirim</td>
                    <td>$row->toko_tdk_kirim</td>
                    <td>$row->toko_tutup</td>
                    ...
                    <td>
                        <div class='hidden-sm hidden-xs action-buttons'>
                            ...
                            <a class='green' href='data_harian/edit/".$row->id."'>
                                <i class='ace-icon fa fa-pencil bigger-130'></i>
                            </a>

                            <a class='red' href='data_harian/delete/".$row->id."' onclick='return ConfirmDialog();'>
