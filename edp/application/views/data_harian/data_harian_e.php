...
<form class="form-horizontal" method="POST" action="<?php echo base_url()?>data_harian\update" >
<input type="hidden" name="id" value="<?php echo $row[0]->id?>"> 
	...
	<div class="form-group">
		...
		<div <div class="col-sm-9">
			<input type="text" name="toko_kirim" size="8" value="<?php echo $row[0]->toko_kirim?>">
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div <div class="col-sm-9">
			<input type="text" name="toko_tdk_kirim" size="8" value="<?php echo $row[0]->toko_tdk_kirim?>">
		</div>
	</div>
	<div class="form-group">
		<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Toko Tutup</label>
		<div <div class="col-sm-9">
			<input type="text" name="toko_tutup" size="8" value="<?php echo $row[0]->toko_tutup?>">
		</div>
	</div>
	<div class="form-group">
