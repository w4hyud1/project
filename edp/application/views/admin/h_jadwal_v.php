...
<body>
    ...
    <div id="topmenu">
            	<ul>
                    ...
                    <li class="current"><a href="<?php echo base_url()?>jadwal">Jadwal</a></li>
            ...
            <div id="content">
       			<div id="rightnow">
                    <h3 class="reallynow">
                        ...
                        ?>
                        <a href="<?php echo base_url()."jadwal/add/".$nperiode;?>" class="add">Add Jadwal Periode : <?php echo $nperiode; ?></a>
                        <br />
                    </h3>
