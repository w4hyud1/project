...
<a href="<?php echo base_url()."update_progtk/add"?>">
    ...
    <?php
        ...
        foreach ($recod as $row) {
            echo "<tr>
                    ...
                    <td>$row->toko_report</td>
                    <td>$row->toko_tdk_report</td>
                    ...
                    <td>
                        <div class='hidden-sm hidden-xs action-buttons'>
                            ...
                            <a class='green' href='update_progtk/edit/".$row->id."'>
                                <i class='ace-icon fa fa-pencil bigger-130'></i>
                            </a>

                            <a class='red' href='update_progtk/delete/".$row->id."' onclick='return ConfirmDialog();'>
