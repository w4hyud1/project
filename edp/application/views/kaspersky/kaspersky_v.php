...
<a href="<?php echo base_url()."kaspersky/add"?>">
    ...
    <?php
        ...
        foreach ($recod as $row) {
            echo "<tr>
                    ...
                    <td>$row->shift</td>
                    <td>$row->status_ok</td>
                    <td>$row->status_cartical</td>
                    <td>$row->status_warning</td>
                    ...
                    <td>
                        <div class='hidden-sm hidden-xs action-buttons'>
                            ...
                            <a class='green' href='kaspersky/edit/".$row->id."'>
                                <i class='ace-icon fa fa-pencil bigger-130'></i>
                            </a>

                            <a class='red' href='kaspersky/delete/".$row->id."' onclick='return ConfirmDialog();'>
